...
public class StudentService extends StudentServiceImplBase {
	...
	//	@Override
	//	// Keep this transactional 
	//	public void deleteStudent(DeleteStudentRequest request,
	//			io.grpc.stub.StreamObserver<DeleteStudentResponse> responseObserver) {
	//		Student entity;
	//		try {
	//			entity=studentRepository.getOne(request.getId());
	//			studentRepository.delete(entity);
	//			eventPublisher.fireEvent(EventUtil.studentDeleted(entity));
	//			
